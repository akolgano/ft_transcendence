...
// Fetch user stats and game results
//fetch('/api/user_dashboard')  // Adjust the endpoint to match your backend
...
//    .then(data => {        
        ...
        // Prepare data for the pie chart (victories vs losses)
        const victories = data.stats.victories;
        const losses = data.stats.losses;

        // Render the pie chart for victories and losses
